...
import rawe.gordon.com.androidrecord.recorder.LocalRecordRecorder;
 ...
 * @author Gordon Rawe
 */
public class LocalRecordActivity extends Activity implements View.OnClickListener {

    private static final String TAG = LocalRecordActivity.class.getCanonicalName();
    //摄像机
    private Camera camera;
    //一个控件
    private LocalRecordRecorder mRecorder;
    //按钮控件
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Callback callback = new Callback() {
            ...
            public void onSuccess(String path) {
                Toast.makeText(LocalRecordActivity.this, path, Toast.LENGTH_SHORT).show();
            }
    ...
    private void initCamera() {
        mRecorder = new LocalRecordRecorder(Constants.MEDIA_FILE_DIR);
