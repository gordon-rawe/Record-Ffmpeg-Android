 ...
 */
public class LocalRecordRecorder implements Camera.PreviewCallback, CameraPreviewView.PreviewEventListener {

    private static final String TAG = LocalRecordRecorder.class.getCanonicalName();
    ...
    public LocalRecordRecorder(String folder) {
        mFolder = folder;
    }
